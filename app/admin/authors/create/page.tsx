...
export default function CreateAuthor() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const authorsUpdated: Author[] =
                    await responseAuthorsUpdated.json();
    ...
    return (
        <section className="py-12 min-h-[92vh]">
            <div className="w-full bg-white dark:bg-gray-800 dark:text-gray-400 flex flex-col items-center">
